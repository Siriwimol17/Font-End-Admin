...
(function() {
    ...
    // const myElement = document.getElementById('editBtn1');

    // if (myElement) {
    //     myElement.addEventListener('click', myElement);
    // } else {
    //     console.error('Element not found');
    // }

    // document.addEventListener('DOMContentLoaded', function () {
    //     // เลือกปุ่มที่คุณต้องการให้มีการคลิก
    //     const profileButton = document.getElementById('editBtn1');
    
    //     // เพิ่ม event listener สำหรับคลิกปุ่ม
    //     profileButton.addEventListener('click', function () {
    //         // ทำการนำทางไปยังหน้า users-profile.html
    ...
    // const buttonHandler1 = new ButtonHandler('contactBtn1', 'users-profile.html');
    // const buttonHandler2 = new ButtonHandler('editBtn2', 'index.html');
